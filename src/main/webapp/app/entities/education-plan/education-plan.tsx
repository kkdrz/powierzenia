  ...
  return (
    <div>
      <h2 id="education-plan-heading">
        <Translate contentKey="powierzeniaApp.educationPlan.home.title">Education Plans</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="powierzeniaApp.educationPlan.home.createLabel">Create new Education Plan</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {educationPlanList && educationPlanList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('studiesType')}>
                  <Translate contentKey="powierzeniaApp.educationPlan.studiesType">Studies Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {educationPlanList.map((educationPlan, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`powierzeniaApp.Specialization.${educationPlan.specialization}`} />
                  </td>
                  <td>
                    <Translate contentKey={`powierzeniaApp.StudiesLevel.${educationPlan.studiesLevel}`} />
                  </td>
                  <td>
                    <Translate contentKey={`powierzeniaApp.StudiesType.${educationPlan.studiesType}`} />
                  </td>
                  <td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="powierzeniaApp.educationPlan.home.notFound">No Education Plans found</Translate>
          </div>
        )}
      </div>
