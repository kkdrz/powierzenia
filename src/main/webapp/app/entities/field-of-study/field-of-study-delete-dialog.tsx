...
import { getEntity, deleteEntity } from './field-of-study.reducer';
...
export const FieldOfStudyDeleteDialog = (props: IFieldOfStudyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="powierzeniaApp.fieldOfStudy.delete.question">
        <Translate contentKey="powierzeniaApp.fieldOfStudy.delete.question" interpolate={{ id: fieldOfStudyEntity.id }}>
          Are you sure you want to delete this FieldOfStudy?
        </Translate>
      </ModalBody>
      <ModalFooter>
