  ...
  return (
    <div>
      <h2 id="field-of-study-heading">
        <Translate contentKey="powierzeniaApp.fieldOfStudy.home.title">Field Of Studies</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="powierzeniaApp.fieldOfStudy.home.createLabel">Create new Field Of Study</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {fieldOfStudyList && fieldOfStudyList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="powierzeniaApp.fieldOfStudy.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="powierzeniaApp.fieldOfStudy.home.notFound">No Field Of Studies found</Translate>
          </div>
        )}
      </div>
