...
import { getEntity, deleteEntity } from './course-class.reducer';
...
export const CourseClassDeleteDialog = (props: ICourseClassDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="powierzeniaApp.courseClass.delete.question">
        <Translate contentKey="powierzeniaApp.courseClass.delete.question" interpolate={{ id: courseClassEntity.id }}>
