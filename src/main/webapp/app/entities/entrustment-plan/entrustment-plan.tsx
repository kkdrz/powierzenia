  ...
  return (
    <div>
      <h2 id="entrustment-plan-heading">
        <Translate contentKey="powierzeniaApp.entrustmentPlan.home.title">Entrustment Plans</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="powierzeniaApp.entrustmentPlan.home.createLabel">Create new Entrustment Plan</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {entrustmentPlanList && entrustmentPlanList.length > 0 ? (
            ...
            <tbody>
              {entrustmentPlanList.map((entrustmentPlan, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`powierzeniaApp.SemesterType.${entrustmentPlan.semesterType}`} />
                  </td>
                  <td>
                    {entrustmentPlan.educationPlanId ? (
                      <Link to={`education-plan/${entrustmentPlan.educationPlanId}`}>{entrustmentPlan.educationPlanId}</Link>
                    ) : (
                      ''
                    )}
                  </td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="powierzeniaApp.entrustmentPlan.home.notFound">No Entrustment Plans found</Translate>
          </div>
        )}
      </div>
