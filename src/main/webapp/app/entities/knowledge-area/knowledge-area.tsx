  ...
  return (
    <div>
      <h2 id="knowledge-area-heading">
        <Translate contentKey="powierzeniaApp.knowledgeArea.home.title">Knowledge Areas</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="powierzeniaApp.knowledgeArea.home.createLabel">Create new Knowledge Area</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {knowledgeAreaList && knowledgeAreaList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="powierzeniaApp.knowledgeArea.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="powierzeniaApp.knowledgeArea.home.notFound">No Knowledge Areas found</Translate>
          </div>
        )}
      </div>
