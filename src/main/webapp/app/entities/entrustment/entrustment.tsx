  ...
  return (
    <div>
      <h2 id="entrustment-heading">
        <Translate contentKey="powierzeniaApp.entrustment.home.title">Entrustments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="powierzeniaApp.entrustment.home.createLabel">Create new Entrustment</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {entrustmentList && entrustmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('hours')}>
                  <Translate contentKey="powierzeniaApp.entrustment.hours">Hours</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="powierzeniaApp.entrustment.courseClass">Course Class</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="powierzeniaApp.entrustment.teacher">Teacher</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {entrustment.entrustmentPlanId ? (
                      <Link to={`entrustment-plan/${entrustment.entrustmentPlanId}`}>{entrustment.entrustmentPlanId}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  ...
                  <td>{entrustment.teacherId ? <Link to={`teacher/${entrustment.teacherId}`}>{entrustment.teacherId}</Link> : ''}</td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="powierzeniaApp.entrustment.home.notFound">No Entrustments found</Translate>
          </div>
        )}
      </div>
