...
export const TeacherUpdate = (props: ITeacherUpdateProps) => {
  ...
  const {teacherEntity, users, classForms, knowledgeAreas, courses, loading, updating} = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : teacherEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label for="teacher-user">User</Label>
                <AvInput id="teacher-user" type="select" className="form-control" name="userId">
                  <option value="" key="0"/>
                  {users
