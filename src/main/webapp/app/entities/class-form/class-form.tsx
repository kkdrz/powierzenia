  ...
  return (
    <div>
      <h2 id="class-form-heading">
        <Translate contentKey="powierzeniaApp.classForm.home.title">Class Forms</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="powierzeniaApp.classForm.home.createLabel">Create new Class Form</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {classFormList && classFormList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="powierzeniaApp.classForm.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {classFormList.map((classForm, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`powierzeniaApp.ClassFormType.${classForm.type}`} />
                  </td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="powierzeniaApp.classForm.home.notFound">No Class Forms found</Translate>
          </div>
        )}
      </div>
