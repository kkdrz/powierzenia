...
import { getEntity, deleteEntity } from './class-form.reducer';
...
export const ClassFormDeleteDialog = (props: IClassFormDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="powierzeniaApp.classForm.delete.question">
        <Translate contentKey="powierzeniaApp.classForm.delete.question" interpolate={{ id: classFormEntity.id }}>
          Are you sure you want to delete this ClassForm?
        </Translate>
      </ModalBody>
      <ModalFooter>
