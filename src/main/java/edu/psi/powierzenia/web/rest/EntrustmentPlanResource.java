...
/**
 * REST controller for managing {@link edu.psi.powierzenia.domain.EntrustmentPlan}.
 */
@RestController
@RequestMapping("/api")
public class EntrustmentPlanResource {
    ...
    public ResponseEntity<EntrustmentPlanDTO> updateEntrustmentPlan(@RequestBody EntrustmentPlanDTO entrustmentPlanDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, entrustmentPlanDTO.getId().toString()))
            .body(result);
    }
