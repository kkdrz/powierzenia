...
/**
 * REST controller for managing {@link edu.psi.powierzenia.domain.ClassForm}.
 */
@RestController
@RequestMapping("/api")
public class ClassFormResource {
    ...
    public ResponseEntity<ClassFormDTO> createClassForm(@RequestBody ClassFormDTO classFormDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ClassFormDTO> updateClassForm(@RequestBody ClassFormDTO classFormDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, classFormDTO.getId().toString()))
            .body(result);
    }
